...
parser.add_argument('-style_weight', help='Style weight. Default is 1', default = 100)
...
parser.add_argument('-output', help='Output file name. Default is "output"', default = 'output15')
args = parser.parse_args()


CONTENT_FILENAME = "input/guitar.wav"
STYLE_FILENAME = "input/suona.wav"
